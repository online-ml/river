...
@pytest.fixture
def dbstream():
    return DBSTREAM(fading_factor=0.001, clustering_threshold=1, cleanup_interval=1, intersection_factor=0.05)
...
def test_cluster_formation_and_cleanup(dbstream: DBSTREAM):
    X = [
        {1: 1}, {1: 3}, {1: 3}, {1: 3}, {1: 5}, {1: 7}, {1: 9},
        {1: 11}, {1: 11}, {1: 13}, {1: 11}, {1: 15}, {1: 17},
    ]
