...
def demo():
    ...
    eval = EvaluatePrequential(show_performance=True, pretrain_size=1000, show_kappa=True, max_instances=5000, batch_size=1,
                               show_scatter_points=False, n_wait=10, max_time=1000, output_file='n10.csv')
