...
<p align="center">
  <code>river</code> is a Python library for <a href="https://www.wikiwand.com/en/Online_machine_learning">online machine learning</a>. All the tools in the library can be updated with a single observation at a time, and can therefore be used to <b>learn from streaming data</b>.
</p>
...
[river](https://river-ml.github.io/) and [scikit-multiflow](https://scikit-multiflow.github.io/) are merging. A new package will result from this merge. Both development teams will work together on this new package.
...
You will still be able to install and use `river` as well as `scikit-multiflow`. Both projects will remain on PyPI, conda-forge and GitHub.
