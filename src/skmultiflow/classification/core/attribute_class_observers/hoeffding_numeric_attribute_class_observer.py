from skmultiflow.classification.core.attribute_class_observers.Binary_tree_numeric_attribute_class_observer \
    import BinaryTreeNumericAttributeClassObserver
