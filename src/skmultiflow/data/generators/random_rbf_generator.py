...
class RandomRBFGenerator(Stream):
    ...
    >>> stream = RandomRBFGenerator(model_seed=99, sample_seed=50, n_classes=4, n_features=10, n_centroids=50)
    ...
    def generate_centroids(self):
        ...
        """
        model_random = check_random_state(self.model_seed)
        self.centroids = []
        ...
        for i in range(self.n_centroids):
            ...
            self.centroids[i].class_label = model_random.randint(self.n_classes)
