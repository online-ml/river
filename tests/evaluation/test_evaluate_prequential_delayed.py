...
def test_evaluate_prequential_delayed_classifier(tmpdir, test_path):
    ...
    data = RandomTreeGenerator(tree_random_state=23, sample_random_state=12, n_classes=4, n_cat_features=2,
    ...
    expected_info = "EvaluatePrequentialDelayed(batch_size=1, data_points_for_classification=False,\n" \
                    ...
                    "                           output_file='prequential_delayed_summary.csv',\n" \
                    "                           pretrain_size=200, restart_stream=True,\n" \
                    "                           show_plot=False)"
