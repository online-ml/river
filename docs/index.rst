...
Information for those interested in contributing to the project. You can also follow the
development on `GitHub  <https://github.com/scikit-multiflow/scikit-multiflow>`_.