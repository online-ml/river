...
The creme library is organized in modules, following the fashion in which scikit-learn is organized.
There is thus a `preprocessing` module as well as a `feature_extraction` module, amongst others.
Furthermore an effort is made to keep the naming of creme's classes and parameters consistent
with scikit-learn.
