...
def clone(estimator, safe=True):
    ...
    elif not (hasattr(estimator, 'get_params') or hasattr(estimator, '_get_params')) \
            or isinstance(estimator, type):
        if not safe:
    ...
    try:
        ...
        new_object_params = estimator._get_params()
    ...
    try:
        ...
        params_set = estimator._get_params()
